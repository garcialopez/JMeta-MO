...
public class MetaheuristicBase {
     ...
     */
    public String getDescription(double[][] individual, int numberVar, int numberObj) {
        ...
        for (int i = 0; i < matrixSize; i++) {
            ...
            for (int j = numberObj; j > 0; j--) {
                descriptionBuilder.append(individual[i][constraintPosition - j]).append("\t");
            }
