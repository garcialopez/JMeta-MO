...
public interface Foraging {
    ...
    /**
     * Applies the reproduction method in the TS-MBFOA algorithm.In the reproduction method, the bacteria are ordered based on a
 constraint management technique.
     *
     * The worst Sb - Sr bacteria are
 ...
 more fit ones.
     ...
     * @param no number objective
     * @param cnop the CNOP problem instance
     */
    public abstract void reproduction(TSMBFOA bacteria, int no, CNOP cnop);
